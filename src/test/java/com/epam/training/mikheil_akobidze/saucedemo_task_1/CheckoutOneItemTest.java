package com.epam.training.mikheil_akobidze.saucedemo_task_1;
...
public class CheckoutOneItemTest extends BaseTest {
    ...
    @Story("Task-1: Checkout one item")
    @Description("Login, add one product to cart, complete checkout and validate success message")
    public void checkoutOneItem(String browser) {
        ...
        inventoryPage.addProductsToCart(TestData.BACKPACK);
